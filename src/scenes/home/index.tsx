    ...
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      >
        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-8 text-sm">
              ...
              quidem sequi vero. Cum cumque quae voluptate
            </p>
          </motion.div>
          {/* ACTIONS */}
          <motion.div
        ...
        <div className="flex basis-3/5 justify-center md:ml-40 md:mt-16 md:justify-items-end">
          ...
          >
            <div>
              <img src={HeaderImage} alt="Image 1" />
            </div>
            <div>
              <img src={HeaderImage} alt="Image 2" />
            </div>
            <div>
              <img src={HeaderImage} alt="Image 3" />
            </div>
          </Carousel>
        </div>
      </motion.div>
